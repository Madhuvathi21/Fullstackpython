...
class bank:
    def __init__(self):
        self.balance=10000
account=bank()
account.balance=1000000000000 # unsafe method , anyone can change
...
################ polymorphism means the same method name can perform different action depending on objects
